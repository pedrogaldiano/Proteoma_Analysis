...
CleanDiannReport <- function() {
  ...
  diannReport <- DiannReport(params$labels) # Not sure if the best approach is to get it inside the function or pass as argument
...
GraphPrecursorRT_mzMapDensity <- function() {
  diannReport <- DiannReport(params$labels)
...
GraphCoefficientOfVariation <- function() {
  ...
  conditions <- unique(DiannReport(params$labels)$condition)
  CVs <- data.frame()
