...
cat("\n\nTotal number of peptides:",n_distinct(diannReport$Stripped.Sequence),
    "\nTotal number of proteins:", n_distinct(diannReport$Protein.Ids,"\n"))
