...
GraphPCA_Kmeans <- function(numberOfClusters = count(colors)) {
  ...
  # identical(pcaComplete, pca_object)
  # identical(pcaTwoDimensions, pca_df)
  # identical(pcaPlot$data, pca_plot$data)
  ...
  pcaPlot <- fviz_pca_ind(pcaComplete,
    ...
    palette = c("tomato", "steelblue", "forestgreen", "firebrick", "black"),#colors,
    addEllipses = FALSE,
...
GraphCoefficientOfVariation <- function() {
  ...
  CreateImputationMatrix(maxitValue = 10, seedValue = 50)
