...
theme_update(text = element_text(color = "black", size = 20),
...
GraphNumberOfPeptidesAndProteins <- function(runs, nmaxPeptides, nmaxProteins) {
  ...
  # Save file
  ggsave(filename = paste(quote(number_of_peptides_and_proteins), ".png", sep=""),
         path = "plots",
...
GraphSparsityMatrix <- function(runs, removeRun = "") {
  ...
  ggsave(filename = paste(quote(sparsity_matrix),".png", sep=""),
         path = "plots",
