...
# PCA
pca <- Generate_Graph_PCA(imputed, numberOfClusters = 2, clusterColors = clusterColor, labels = fancyLabels)

# Coefficient of Variation
CVs <- Generate_Graph_Coef_Variation(imputed, unique(diannReport$condition), fancyLabels, colors)


combine <- patchwork::wrap_plots(list(cosineSimilarity, kmeans, pca, CVs), cols = 4, nrow =)
