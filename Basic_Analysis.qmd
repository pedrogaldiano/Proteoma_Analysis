...
write.csv(diannMatrix, paste0(dir, "diannMatrix_HY.csv"))

# Yeast
yeast_DiannMatrix <- log2(Make_DiannMatrix(yeast_DiannReport, header = "Genes") + 1)
write.csv(yeast_DiannMatrix, paste0(dir, "diannMatrix_YEAST.csv"))

# HeLa
human_DiannMatrix <- log2(Make_DiannMatrix(human_DiannReport, header = "Genes") + 1)
write.csv(human_DiannMatrix, paste0(dir, "diannMatrix_HeLa.csv"))
