...
# nrow(filtered) # 7983 (sparsity = 0)

# remove 15% of the proteins

# simulated <- mice::ampute(complete, prop = 0.15, bycases = FALSE)
...
saveRDS(imp_Mean, "imp_MIDAS.rds")
...
saveRDS(imp_Mean, "imp_LASSO_NORM.rds")
...
saveRDS(imp_Mean, "imp_LASSO_SELECT.rds")


# ------
start <- Sys.time()

imputedMatrix_StepWise <- Create_ImputationMatrix_StepWise(
  simulated,
  override = TRUE
)
...
saveRDS(imp_Mean, "imp_StepWise.rds")
