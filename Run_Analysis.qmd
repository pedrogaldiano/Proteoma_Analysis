...
precursorRT <- Generate_Graph_PrecursorRT(dr, labels_names, colors)
...
ionCloud <- Generate_IonCloud(dr, labels_names)
...
nPeptides <- Generate_Graph_NumberOfPeptides(dr, labels_names, colors)
...
nProteins <- Generate_Graph_NumberOfProteins(dr, labels_names, colors)
