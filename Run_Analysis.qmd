...
#Save limma result in a .tsv file
write.table(number_significantProteins,
            file = "./data/output/number_significantProteins.tsv",
            quote = FALSE,
            sep = '\t',
            col.names = NA)

blandAltmanPlot <- Generate_Graph_BlandAltman(limmaResult, genesToHighLight_BlandAltman)

ggplot2::ggsave(paste0("Bland_Altman", ".png"),
                path = "./data/output/",
...
proteinComparisonPlot <- Compare_ProteinsAbundance(imputedMatrix,
...
ggplot2::ggsave(paste0("Proteins_Comparison", ".png"),
                path = "./data/output/",
