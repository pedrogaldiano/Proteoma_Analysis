...
HY_diannMatrix <- as.matrix(log2(Make_DiannMatrix(diannReport, header = "Genes") + 1))
...
# Mean by column TESTEEE
```{r}

for (mtx in names(matrices)) {

  print(mtx)

  print(matrices[[mtx]][1,1])
  
}


mtx <- organism_matrices[1]
result <- mtx
